...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets_home/assets/images/inilogo.png'); ?>" type="image/x-icon" />
	<link rel="apple-touch-icon" href="<?php echo base_url('assets_home/assets/images/inilogo.png'); ?>" />
	<meta name="theme-color" content="#e22454" />
	<meta name="apple-mobile-web-app-capable" content="yes" />
	<meta name="apple-mobile-web-app-status-bar-style" content="black" />
	<meta name="apple-mobile-web-app-title" content="drfashion" />
	<meta name="msapplication-TileImage" content="<?php echo base_url('assets_home/assets/images/inilogo.png'); ?>" />
							...
							<div class="menu-left">
								<div class="brand-logo">
									<a href="<?php echo base_url(); ?>">
										<img style="height: 60px;" src="<?php echo base_url('assets_home/assets/images/inilogo.png'); ?>" class="brand img-fluid blur-up lazyload" alt="logo">
									</a>
								</div>
							</div>
							<nav>
