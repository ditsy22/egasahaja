...
<head>
	...
	<!-- End layout styles -->
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets_login/images/inilogo.png">
</head>
<?php
	...
	<div class="container-scroller">
				...
				<li class="nav-item nav-profile border-bottom">
					<a href="#" class="nav-link flex-column">
						<div class="nav-profile-image">
							<img src="<?php echo base_url(); ?>assets_admin/iconuser.png" alt="profile" />
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
				<div class="navbar-menu-wrapper d-flex align-items-stretch" style="background-color: #FF5BAE;">
					<button style="background-color: #FF71CD;" class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
